    ...
    <section className="mx-auto w-full max-w-md">
      <div className="rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
        <div className="mb-6">
          ...
          <p className="mt-2 text-sm text-zinc-600">Start building your learning profile.</p>
        </div>
        ...
        <form className="space-y-4">
          ...
          <div>
            <label htmlFor="register-email" className="block text-sm font-medium text-zinc-800">
              Email
            </label>
            <input
              id="register-email"
